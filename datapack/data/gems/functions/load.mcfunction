...
scoreboard objectives add right_click_gem used:carrot_on_a_stick
...
scoreboard objectives add on_off_pot_air_gem dummy
scoreboard objectives add on_off_pot_phantom_gem dummy
scoreboard objectives add on_off_pot_space_gem dummy
